export const ROUTES = {
  v1: {
    ...
    notification: {
      ...
      markAsRead:
        '/api/v1/lumara/notification/:id([0-9a-fA-F]{24})/mark-as-read',
    ...
    wallet: {
      ...
      accessor: {
        ...
        delete:
          '/api/v1/lumara/wallet/:id([0-9a-fA-F]{24})/accessor/:accessorId([0-9a-fA-F]{24})',
        update:
          '/api/v1/lumara/wallet/:id([0-9a-fA-F]{24})/accessor/:accessorId([0-9a-fA-F]{24})',
      },
      transaction: {
    ...
    wishlist: {
      ...
      item: {
        update:
          '/api/v1/lumara/wishlist/:id([0-9a-fA-F]{24})/item/:itemId([0-9a-fA-F]{24})',
      },
      accessor: {
        create: '/api/v1/lumara/wishlist/:id([0-9a-fA-F]{24})/accessor',
        update:
          '/api/v1/lumara/wishlist/:id([0-9a-fA-F]{24})/accessor/:accessorId([0-9a-fA-F]{24})',
        delete:
          '/api/v1/lumara/wishlist/:id([0-9a-fA-F]{24})/accessor/:accessorId([0-9a-fA-F]{24})',
      },
    },
